...
class PulumiCommand {
    ...
    static async installWindows(opts) {
        const response = await got_1.default("https://get.pulumi.com/install.ps1");
    ...
    static async installPosix(opts) {
        const response = await got_1.default("https://get.pulumi.com/install.sh");
